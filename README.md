...
Code sources:
- `adventure.ts` and `index.html` were created for this project [Adam Smith](https://github.com/rndmcnlly) and edited by me.
- `main.ts` was sketched by [Adam Smith](https://github.com/rndmcnlly) and rewritten by me.